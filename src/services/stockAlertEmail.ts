...
function buildHtmlContent(products: ProductAlert[], siteNom?: string): string {
  ...
  // Tri : ruptures en premier, puis stock bas trié par ratio croissant
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border-radius:10px;overflow:hidden;border:1px solid #E2E8F0;">
            <thead>
              <tr style="background:#F1F5F9;">
                <th style="padding:10px 12px 10px 16px;text-align:left;color:#64748B;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border-bottom:1px solid #E2E8F0;">Article &amp; Emplacement</th>
